...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-AKSCluster-mdet"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "terraformmdet"      # mettre le nom du compte de stockage créer dans le lab 1
